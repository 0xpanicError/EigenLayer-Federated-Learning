    ...
    IFLTaskManager
{
    ...
    function createNewTask(
        uint256[] baseParamters,
        uint32 quorumThresholdPercentage,
        bytes calldata quorumNumbers
    ) external onlyTaskGenerator {
        // create a new task struct
        Task memory newTask;
        newTask.baseParameters = baseParamters;
    ...
    // SLASHING Conditions and logic is not implemented yet
    // Challenge logic is not implemented yet
